...
#ifndef _aspect_particle_integrator_rk_2_first_order_time_h
#define _aspect_particle_integrator_rk_2_first_order_time_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Integrator
    {
       ...
       */
      template <int dim>
      class RK2FirstOrderTime : public Interface<dim>, public SimulatorAccess<dim>
      {
        public:
          RK2FirstOrderTime();
